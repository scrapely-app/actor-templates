...
A production-ready Scrapely Actor template built on `PlaywrightCrawler` in TypeScript. Give it
a list of starting URLs and it loads each page in a headless Chromium browser, enqueues the
...
- **TypeScript** with a strict `tsconfig.json`
