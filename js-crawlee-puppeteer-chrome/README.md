...
A production-ready Scrapely Actor template built on `PuppeteerCrawler`. Give it a list of
starting URLs and it loads each page in a headless Chrome browser, enqueues the links it
